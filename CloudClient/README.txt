...
CloudClient v.1.6.1 to latest version, works with CloudServer v.1.1.5 to latest version.

CloudClient v.1.0.0 to v.1.5.1, works with CloudServer v.1.0.0 to v.1.0.5.
