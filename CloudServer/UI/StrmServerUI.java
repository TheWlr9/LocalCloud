...
public class StrmServerUI
{
    ...
    final private static String TITLE= "Strm Server Control Panel beta-1.1.2";
                ...
                mouseY>BUTTON_Y-BUTTON_HEIGHT/2 && mouseY<BUTTON_Y+BUTTON_HEIGHT/2){
                    ...
                    if(serverPid!=0){ //User wants to stop the server
                        try{
                            ...
                            Runtime.getRuntime().exec("kill "+serverPid); //LINUX
                        ...
                        if(ipAddress!=null){
                            ...
                            //Start the server
                            try{
                                serverProcess= Runtime.getRuntime().exec("java -jar -server StrmServerBE.jar "+password+" "+cloudPath);
